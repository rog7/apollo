...
import MidiInputDefaultMessage from "./MidiInputDefaultMessage";
import BackArrowSvg from "./svg/BackArrowSvg";
import EnterModeArrow from "./svg/EnterModeArrow";
import HomeSvg from "./svg/HomeSvg";
import SearchModeSvgTop from "./svg/SearchModeSvgTop";
...
const SearchMode = ({ noteOnColor, onSearch, setHidePremiumButton }: Props) => {
  ...
  const [showPopupModal, setShowPopupModal] = useState(
    getItem("show-search-modal-popup") === "true" ||
      getItem("show-search-modal-popup") === null
  );
    ...
    <div>
      ...
      {showPopupModal && (
        <div className="flex items-center justify-center h-screen">
          <div
            className={`z-10 relative rounded-2.5xl w-[358px] h-[421px]`}
            style={{
          ...
          >
            ...
            <div
              className={`absolute top-[3px] left-[3px] rounded-2.5xl w-[349px] h-[411px]`}
              style={{
                backgroundColor:
            ...
            >
              <div className="flex flex-col items-center mt-[75px]">
                <div className="flex flex-col gap-[5px]">
                  <div>
                    <p
                      className={`text-2.5xl font-bold text-center`}
                      style={{
                ...
                <div className="flex flex-col mt-[20px] gap-[20px]">
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      >
                        Search through matching chords
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-[6px] items-center justify-center mt-[5px]">
                    <div
                      className={`cursor-pointer relative w-[15px] h-[15px] rounded-sm border-[1px]`}
                      onClick={handleCheckboxChange}
                      style={{
                        borderColor: utils.determineBorderColorForCheckbox(),
                        backgroundColor:
                          utils.determineBackgroundColorForCheckbox(),
                      }}
                    >
                      {isChecked && (
                        <span
                          className={`scale-75 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2`}
                          style={{
                            color: utils.determineBackgroundColorReverse(),
                          }}
                        >
                          ✓
                        </span>
            ...
            <div
              ...
              onClick={() => {
                setItem("show-search-modal-popup", !isChecked);
      ...
      <div className={`fixed h-screen ${showPopupModal ? "opacity-20" : ""}`}>
        <div
          ...
          } cursor-pointer z-20 absolute top-[42px] left-[42px]`}
          onClick={goBackToHomePage}
        >
          <HomeSvg />
        </div>
                    ...
                    style={{
                      cursor:
                        index.current === searchResults.length - 1
                          ...
                          : "pointer",
                      opacity:
                        index.current === searchResults.length - 1 ? 0 : 1,
                    }}
                    onClick={
                      index.current !== searchResults.length - 1
                        ? handleGoingForwardInSearchResults
